...
func DecodeBumpTagForTidbxRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*hotfix.BumpTagForTidbxPayload, error) {
	return func(r *http.Request) (*hotfix.BumpTagForTidbxPayload, error) {
		var payload *hotfix.BumpTagForTidbxPayload
		var (
...
func DecodeQueryTagOfTidbxRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*hotfix.QueryTagOfTidbxPayload, error) {
	return func(r *http.Request) (*hotfix.QueryTagOfTidbxPayload, error) {
		var payload *hotfix.QueryTagOfTidbxPayload
		var (
			repo string
			tag  string
			err  error
