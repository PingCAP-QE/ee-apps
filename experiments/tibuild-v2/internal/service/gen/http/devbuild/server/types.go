...
type UpdateRequestBody struct {
	// Build to update
	Build *DevBuildRequestBody `form:"build,omitempty" json:"build,omitempty" xml:"build,omitempty"`
}
...
type DevBuildRequestRequestBody DevBuildSpecRequestBody
...
func NewUpdatePayload(body *UpdateRequestBody, id int, dryrun bool) *devbuild.UpdatePayload {
	...
	v.Build = unmarshalDevBuildRequestBodyToDevbuildDevBuild(body.Build)
	v.ID = id
	v.Dryrun = dryrun
