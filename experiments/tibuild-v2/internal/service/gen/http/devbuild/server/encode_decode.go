...
// endpoint.
func DecodeListRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*devbuild.ListPayload, error) {
	return func(r *http.Request) (*devbuild.ListPayload, error) {
		var payload *devbuild.ListPayload
		var (
			page      int
			pageSize  int
			hotfix    bool
...
// create endpoint.
func DecodeCreateRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*devbuild.CreatePayload, error) {
	return func(r *http.Request) (*devbuild.CreatePayload, error) {
		var payload *devbuild.CreatePayload
		var (
...
// endpoint.
func DecodeGetRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*devbuild.GetPayload, error) {
...
// update endpoint.
func DecodeUpdateRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*devbuild.UpdatePayload, error) {
	return func(r *http.Request) (*devbuild.UpdatePayload, error) {
		var payload *devbuild.UpdatePayload
		var (
...
// endpoint.
func DecodeRerunRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*devbuild.RerunPayload, error) {
	return func(r *http.Request) (*devbuild.RerunPayload, error) {
		var payload *devbuild.RerunPayload
		var (
			id     int
			dryrun bool
			err    error
