...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"Healthz", "GET", "/api/v2/healthz"},
			{"Livez", "GET", "/api/v2/livez"},
		},
...
// MountHealthzHandler configures the mux to serve the "health" service
// "healthz" endpoint.
...
// MountLivezHandler configures the mux to serve the "health" service "livez"
// endpoint.
