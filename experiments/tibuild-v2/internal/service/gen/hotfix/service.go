...
type Service interface {
	...
	CreateTag(context.Context, *CreateTagPayload) (res *HotfixTagResult, err error)
}
...
// MethodKey key.
var MethodNames = [1]string{"createTag"}

// CreateTagPayload is the payload type of the hotfix service createTag method.
...
// HotfixTagResult is the result type of the hotfix service createTag method.
