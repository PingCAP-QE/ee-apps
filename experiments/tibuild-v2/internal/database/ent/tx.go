...
func (tx *Tx) init() {
	tx.DevBuild = NewDevBuildClient(tx.config)
	tx.ImageSyncTask = NewImageSyncTaskClient(tx.config)
}
...
// applies a query, for example: DevBuild.QueryXXX(), the query will be executed
