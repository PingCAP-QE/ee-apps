...
func (j *Jenkins) GetBuildFromQueueID(ctx context.Context, queueid int64, jobname string) (*Build, error) {
	...
	println("1: " + task.Raw.Task.Name)

	job, err := task.GetJob(ctx, jobname)
