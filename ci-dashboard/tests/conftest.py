...
def _create_test_schema(engine: Engine) -> None:
    statements = [
        ...
        CREATE TABLE ci_l1_builds (
          ...
          jenkins_queue_total_subtasks_sum INTEGER NULL,
          jenkins_building_subtasks_sum INTEGER NULL,
          jenkins_subtask_count INTEGER NULL,
          log_gcs_uri TEXT NULL,
          error_l1_category TEXT NULL,
          error_l2_subcategory TEXT NULL,
          revise_error_l1_category TEXT NULL,
          revise_error_l2_subcategory TEXT NULL,
        ...
        CREATE TABLE cost_attribution_daily (
          ...
          service TEXT NULL,
          project TEXT NULL,
          service_exec_id TEXT NULL,
          attribution_key TEXT NULL,
          attribution_source TEXT NOT NULL,
          attribution_status TEXT NOT NULL,
          allocate_method TEXT NULL,
