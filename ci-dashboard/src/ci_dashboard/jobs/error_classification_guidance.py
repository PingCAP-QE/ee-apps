...
- Bazel missing-blob failures such as `Failed to fetch blobs because they do not exist remotely.: Missing digest: ... for bazel-out/...` are INFRA/BAZEL_CACHE_MISS, not BUILD/COMPILE.
