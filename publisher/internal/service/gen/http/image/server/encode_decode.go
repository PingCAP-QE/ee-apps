...
func DecodeRequestToCopyRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*image.RequestToCopyPayload, error) {
	return func(r *http.Request) (*image.RequestToCopyPayload, error) {
		var (
...
func DecodeQueryCopyingStatusRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*image.QueryCopyingStatusPayload, error) {
	return func(r *http.Request) (*image.QueryCopyingStatusPayload, error) {
		var (
			requestID string
			err       error
...
func DecodeRequestMultiarchCollectRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*image.RequestMultiarchCollectPayload, error) {
	return func(r *http.Request) (*image.RequestMultiarchCollectPayload, error) {
		var (
...
func DecodeQueryMultiarchCollectStatusRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*image.QueryMultiarchCollectStatusPayload, error) {
	return func(r *http.Request) (*image.QueryMultiarchCollectStatusPayload, error) {
		var (
			requestID string
			err       error
