...
// +kubebuilder:rbac:groups=tibuild.pingcap.net,resources=macbuilds,verbs=get;list;watch;delete
// +kubebuilder:rbac:groups=tibuild.pingcap.net,resources=macbuilds/status,verbs=get
