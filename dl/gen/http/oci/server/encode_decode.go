...
// list-files endpoint.
func DecodeListFilesRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*oci.ListFilesPayload, error) {
	return func(r *http.Request) (*oci.ListFilesPayload, error) {
		var (
			repository string
			tag        string
			err        error
...
func DecodeDownloadFileRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*oci.DownloadFilePayload, error) {
	return func(r *http.Request) (*oci.DownloadFilePayload, error) {
		var (
			repository string
			tag        string
			file       *string
...
func DecodeDownloadFileSha256Request(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*oci.DownloadFileSha256Payload, error) {
	return func(r *http.Request) (*oci.DownloadFileSha256Payload, error) {
		var (
			repository string
			file       string
			tag        string
